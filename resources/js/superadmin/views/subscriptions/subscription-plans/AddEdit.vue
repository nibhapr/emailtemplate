                    ...
                    <a-form-item
                        ...
                        :help="
                            rules.stripe_monthly_plan_id
                                ...
                                : null
                        "
                        :validateStatus="rules.stripe_monthly_plan_id ? 'error' : null"
                    >
                        <a-input
                ...
                <a-col :xs="24" :sm="24" :md="24" :lg="24">
                    ...
                    >
                        <a-row :gutter="[16, 16]">
                            ...
                            <a-col :span="8">
                                <a-checkbox value="salesman">
                                    {{ $t("subscription_plans.salesman") }}
                                </a-checkbox>
                            </a-col>
                            <a-col :span="8">
                                <a-checkbox value="lead_follow_up">
                                    {{ $t("subscription_plans.lead_follow_up") }}
                                </a-checkbox>
                            </a-col>
                            <a-col :span="8">
                                <a-checkbox value="lead_notes">
                                    {{ $t("subscription_plans.lead_notes") }}
                                </a-checkbox>
                            </a-col>
                            <a-col :span="8">
                                <a-checkbox value="lead_call_log">
                                    {{ $t("subscription_plans.lead_call_log") }}
                                </a-checkbox>
                            </a-col>
                        </a-row>
                    </a-checkbox-group>
